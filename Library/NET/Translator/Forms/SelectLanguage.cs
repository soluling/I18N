...
namespace NewTool.Forms
{
  ...
  /// to use this dialog. You can use the lower lever functions in the <see cref="T:NewTool.Resources"/> class to build your own UI to show and select the language and
  /// once selected you can use the <see cref="T:NewTool.Forms.Translator"/> class to set the language of your application into the selected language.
  /// </remarks>
  /// <example>
  /// <para>
  ...
  public partial class SelectLanguage : Form
  {
    ...
    {
      InitializeComponent();
      Populate(Resources.OriginalLanguage);
    }
