...
{
  /// <summary>
  /// Delegate type that is used in the <see cref="E:NewTool.WPF.Translator.TranslateElementEvent"/> event.
  /// </summary>
  ...
  /// <summary>
  /// Delegate type that is used in the <see cref="E:NewTool.WPF.Translator.TranslateObjectEvent"/> event.
  /// </summary>
  /// <param name="sender"></param>
  ...
  public class Translator
  {
    ...
    private void LoadAssembly()
    {
      ...
      if (Resources.Language != "")
      {
        ...
        assemblyFileName = Path.Combine(Path.GetDirectoryName(applicationFileName), Resources.Language);
    ...
    private BamlControl LoadBaml(string name)
    {
      ...
      if (assemblyName == "")
        assemblyName = Resources.GetAssemblyName(Assembly.GetCallingAssembly());

      string language = Resources.Language;
      ...
      if ((language != "") && (language != Resources.OriginalLanguage))
