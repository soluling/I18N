...
begin
  ...
  begin
    offset := FStream.ReadInt32;
    len := FStream.ReadInt32 div 2;

    str := FStream.ReadString(FOffset + offset, len);
...
function TNtDelphiResource.FindString(const original: String; id: String; const group: String): String;
var
  i, j, stringCount: Integer;
  offset, len, thisOffset: Integer;
  groupOffset: Integer;
  str: String;
begin
  if id = '' then
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        str := FStream.ReadString(groupOffset + offset, len);
...
begin
  ...
  begin
    ...
    item.FId := FStream.ReadAnsi(offset, len);
