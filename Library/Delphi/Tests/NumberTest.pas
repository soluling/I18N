...
procedure TNumberTest.Process(value: Double; const long, short, currency: String);
...
procedure TNumberTest.Japanese;
begin
  Language := 'ja';
...
initialization
  ...
  RegisterTest(TNumberTest.Suite);
end.
