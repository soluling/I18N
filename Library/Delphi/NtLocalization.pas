...
type
  ...
  public
    ...
    { Restores a replaced function.
      This has effection only on 32-bit applications.
      @param data         Structure that stores information of the replaced function. }
    class procedure RestoreProcedure(data: TNtProcedureData);
  end;
...
function EnumResourceLanguagesProc(
  instance: THandle;  //FI:O804
  resType: PChar;  //FI:O804
  resName: PChar;  //FI:O804
  languageId: Word;
...
class procedure TNtMap.RestoreProcedure(data: TNtProcedureData);
{$IFDEF WIN32}
var
