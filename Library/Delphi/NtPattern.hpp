...
// (DO NOT EDIT: machine generated header) 'NtPattern.pas' rev: 33.00 (Windows)
...
enum DECLSPEC_DENUM TPlaceholderKind : unsigned char { pkPrintf, pkDoubleBrace, pkSingleBrace };
...
public:
	...
	__classmethod bool __fastcall IsPattern(const System::UnicodeString pattern);
	__property int Count = {read=GetCount, nodefault};
