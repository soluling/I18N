namespace FileDialog
{
  partial class Form1
  {
    ...
    private void InitializeComponent()
    {
      ...
      // openButton3
      // 
      resources.ApplyResources(this.openButton3, "openButton3");
      ...
      // openButton4
      // 
      resources.ApplyResources(this.openButton4, "openButton4");
      this.openButton4.Name = "openButton4";
      this.openButton4.UseVisualStyleBackColor = true;
      this.openButton4.Click += new System.EventHandler(this.openButton4_Click);
      // 
      // label1
      // 
      ...
      this.Controls.Add(this.openButton4);
