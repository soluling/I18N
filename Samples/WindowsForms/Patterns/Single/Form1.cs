...
namespace SinglePlural
{
  public partial class Form1 : Form
  {
    ...
    {
      return NewTool.MultiPattern.Format(Properties.Resources.MessagePlural, count, count);
      //return NewTool.Plural.Format(Properties.Resources.OtherMessagePlural, count, count);
    }
