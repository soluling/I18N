...
begin
  ...
  FTexts.Add(NAME, 'PlainAnsi');
  FTexts.Add(NAME, 'PlainUtf8');
  FTexts.Add(NAME, 'PlainUtf16');
  FTexts.Add(NAME, 'PlainUtf16Be');

  FTexts.Add(NAME, 'SegmentedAnsi');
  FTexts.Add(NAME, 'SegmentedUtf8');
  FTexts.Add(NAME, 'SegmentedUtf16');
  FTexts.Add(NAME, 'SegmentedUtf16Be');
