...
procedure TForm1.UpdateValues;
  ...
  resourcestring
    ...
    SSportSelect = 'soccer;%s is the best soccer player.;hockey;%s is the best ice hockey player.;basketball;%s is the best basketball player.'; //loc 0: Name of the player
    // Note! Name the gender enabled resource strings as XXXSelect. This will automatically turn on multi-part parsing in NewTool's editor.
  begin
