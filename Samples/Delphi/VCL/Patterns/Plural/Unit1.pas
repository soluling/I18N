...
resourcestring
  ...
  SZeroMessagePlural = 'zero;No files;one;%d file;other;%d files'; //loc 0: Amount of files
  // Note! Name the plural enabled resource strings as XXXPlural. This will automatically turn on plural parsing in NewTool's editor.
