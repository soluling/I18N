...
resourcestring
  ...
  SMessageGender = 'male;%s will bring his bicycle;female;%s will bring her bicycle';  //loc 0: Name of a person
  // Contains three patterns: neutral, male and female.
  SOtherMessageGender = 'male;%s will bring his bicycle;female;%s will bring her bicycle;other;%s will bring a bicycle';  //loc 0: Name of a person
  // Note! Name the gender enabled resource strings as XXXGender. This will automatically turn on multi pattern parsing in NewTool's editor.
