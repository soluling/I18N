...
begin
  ...
  PatternEdit.Items.Add('one;I have %d car;other;I have %d cars');
  // English pattern with optional zero part
  PatternEdit.Items.Add('zero;I have no cars;one;I have one car;other;I have %d cars');
  // Pattern with several custom operator parts
  PatternEdit.Items.Add('=0;I have no cars;one;I have %d car;=2;I have two cars;~12;I have a dozen cars;>=20;I must be a car dealer;other;I have %d cars');
