...
procedure TForm1.FormCreate(Sender: TObject);
  ...
  resourcestring
    ...
    SMessagePlural = 'one;%d file;other;%d files';  //loc 0: Amount of files
    // Contains three patterns: zero, one and other.
    SZeroMessagePlural = 'zero;No files;one;One file;other;%d files';  //loc 0: Amount of files
    // Contains four patterns: zero, one, two and other.
    STwoMessagePlural = 'zero;No files;one;One file;two;Two files;other;%d files';  //loc 0: Amount of files
    // Contains four patterns: =0, one, =2 and other.
    S2MessagePlural = '=0;No files;one;One file;=2;Two files;other;%d files';  //loc 0: Amount of files
    // Contains fixed patterns: =0, =1, =2, <6, <=10, ~12 and other.
    STextMessagePlural = '=0;No files;=1;One file;=2;Two files;<6;Few files;<=10;Several files;~12;A dozen files;other;Lots of files';  //loc 0: Amount of files
