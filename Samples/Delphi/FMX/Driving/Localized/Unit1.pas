...
begin
  ...
  ResultLabel.Text := TMultiPattern.Format(_T('Driving time%s;zero;%1:s;one; %d hour%1:s;other; %d hours%1:s;next;one; %d minute.;other; %d minutes.', 'ResultPlural'), [hours, minutes]);
end;
